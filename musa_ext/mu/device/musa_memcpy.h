					...
					mStatus MusaMemcpyD2H(void* h, const void* d, size_t btype);
							mStatus MusaMemcpyH2D(void* d, const void* h, size_t btype);
									mStatus MusaMemcpyD2D(void* d1, const void* d2, size_t btype);
											...
											mStatus MusaMemcpyAsyncD2H(void* h, const void* d, size_t btype, musaStream_t s = 0);
													mStatus MusaMemcpyAsyncH2D(void* d, const void* h, size_t btype, musaStream_t s = 0);
															mStatus MusaMemcpyAsyncD2D(void* d1, const void* d2, size_t btype, musaStream_t s = 0);
