...
NodeDef* MusaGraphUtils::CreateConstNode(GraphDef* graph,
                                         const string& name,
...
NodeDef* MusaGraphUtils::InsertCast(GraphDef* graph, const string& name, const string& input_name, 
...
void MusaGraphUtils::RedirectEdges(GraphDef* graph,
